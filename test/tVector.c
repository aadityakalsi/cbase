...
TEST_FUNC( vectorint )
{
    ...
    {/* test push */
        ...
        TEST_TRUE( cbase_vector_cb_int32_size(v) == 21 );
        TEST_TRUE( cbase_vector_cb_int32_cap(v)  == 32 );
        TEST_TRUE( v[20] == 1 );
        ++sz;
        v = cbase_vector_cb_int32_push(v, 2);
        TEST_TRUE( cbase_vector_cb_int32_size(v) == 22 );
        TEST_TRUE( cbase_vector_cb_int32_cap(v)  == 32 );
        TEST_TRUE( v[21] == 2 );
        ++sz;
        for (; i != 10; ++i) {
            cb_int32* v1 = cbase_vector_cb_int32_push(v, 10);
            TEST_TRUE( cbase_vector_cb_int32_size(v) == i+sz+1 );
            TEST_TRUE( cbase_vector_cb_int32_cap(v)  == 32 );
        ...
        {/* beyond pow 2 capacity */
            ...
            TEST_TRUE( v != v1 );
            TEST_TRUE( cbase_vector_cb_int32_size(v1) == 33 );
            TEST_TRUE( cbase_vector_cb_int32_cap(v1)  == 64 );
            v = v1;
        } 
    }
    {/* test resize */
        ...
        ASSERT_TRUE( v == v1 );
        TEST_TRUE( cbase_vector_cb_int32_size(v) == 5 );

        v1 = cbase_vector_cb_int32_resize(v, 5000);
        ASSERT_TRUE( v != v1 );
        TEST_TRUE( cbase_vector_cb_int32_size(v1) == 5000 );
        TEST_TRUE( cbase_vector_cb_int32_cap(v1) == 8192 );
        v = v1;
    }
